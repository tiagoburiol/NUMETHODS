...
O material consiste em um conjunto de Jupyter Notebooks ([jupyter.org](http://kramdown.gettalong.org "hp") ), scripts Python (python.org) e páginas HTML contendo o material para acompanhamento do curso.   
