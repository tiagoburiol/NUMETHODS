...
O material consiste em um conjunto de [Jupyter Notebooks] (http://kramdown.gettalong.org "hp"), scripts [Python] (python.org) e páginas [HTML](https://www.w3.org/html/) contendo o material para acompanhamento do curso.   
